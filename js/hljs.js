...
"meta-keyword":"if else elseif end region externalsource"}}]}}}());hljs.registerLanguage("bash",function(){"use strict";return function(e){
...
begin:/\b(print|exec)\(/}]}}}());hljs.registerLanguage("excel",function(){"use strict";return function(E){return{
...
begin:"%",end:"%"},{begin:"`",end:"`",contains:[{begin:/\\./}]}]}}}());hljs.registerLanguage("perl",function(){"use strict";return function(e){var n={
$pattern:/[\w.]+/,
