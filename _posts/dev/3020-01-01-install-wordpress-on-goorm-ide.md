...
![그림00](https://zininote.github.io/img/dev/dev-3020-01-01-00.png)

## 설정 및 설치

지금까지는 워드프레스 설치를 위한 php 서버가 준비되었을 뿐이다. IDE 내부를 보면 아래처럼 터미널 화면이 보이는데 여기에 이것저것 명령어를 순차적으로 입력해야 한다.

![그림01](https://zininote.github.io/img/dev/dev-3020-01-01-01.png)
...
![그림03](https://zininote.github.io/img/dev/dev-3020-01-01-03.png)
...
![그림04](https://zininote.github.io/img/dev/dev-3020-01-01-04.png)
...
![그림05](https://zininote.github.io/img/dev/dev-3020-01-01-05.png)

이후의 워드프레스 설정도 알아서 진행하면 된다.

워드프레스 초기 대시보드까지 나타났다면, 이제 다시 구름 IDE 창으로 돌아가보자. 아래 그림과 같이, 파일 목록에 `wp-config.php` 파일이 생성이 돼있을 것이다.

![그림06](https://zininote.github.io/img/dev/dev-3020-01-01-06.png)
...
![그림07](https://zininote.github.io/img/dev/dev-3020-01-01-07.png)
